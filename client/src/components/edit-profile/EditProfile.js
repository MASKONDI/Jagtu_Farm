...
class CreateProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      //if user doesn't have a website filled in the profile
      // Bring productList array back to csv
      const productListCSV = profile.productList.join(",");
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <TextFieldGroup
                  ...
                  info="City or city & state suggested (eg. Kanpur,Noida)"
                />
                <TextFieldGroup
